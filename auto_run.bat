@echo off
set link_manga="https://sakuramanga.net/truyen-tranh-tieng-nhat-japanese-manga/con-duong-mua-xuan/ao-haru-ride-chap-"
set dest_dir="D:\manga\AHR"
set vid_type="avi"
set /a multi_chap= 0
set /a chapter=3
set /a chapter_finished=40
