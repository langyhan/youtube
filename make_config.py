...
if sys.argv[1] == "link.txt":
    ...
    message = r"https://sakuramanga.net/truyen-tranh-tieng-nhat-japanese-manga/great-teacher-onizuka-tieng-nhat/great-teacher-onizuka-japanese-chap-"
    min = int(sys.argv[2])
    max = int(sys.argv[3])
    with open("link.txt", "a") as myfile:
        for i in range(min,max+1):
            #myfile.write(r"C:\Users\dungdt5\Desktop\truyen\shokugeki\Shokugeki no Soma " + str(i) + "\n")
            myfile.write(message + str(i) + "/\n")
